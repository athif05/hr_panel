...
class FreshEyeJournalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $pocket_money='';
        $publishers='';
        $tech_operations_development='';
        $support_ea_pa='';
        $education='';
        $igaming='';
        $tech_operations_shopify='';
        $tech_operations_creative='';
        $mobile='';
        $vcommission_uk='';
        ...
        if($request->admin_operations){
            $admin_operations=$request->admin_operations;
        }

        if($request->advertiser_sales){
            $advertiser_sales=$request->advertiser_sales;   
        }

        if($request->advertisers){
            $advertisers=$request->advertisers;
        }

        if($request->finance_accounts){
            $finance_accounts=$request->finance_accounts;
        }

        if($request->human_resources){
        ...
        if($request->network_operations){
            $network_operations=$request->network_operations;
        }

        if($request->pocket_money){
            $pocket_money=$request->pocket_money;
        }
        ...
        if($request->tech_operations_development){
            $tech_operations_development=$request->tech_operations_development;
        }

        if($request->support_ea_pa){
            $support_ea_pa=$request->support_ea_pa;
        }
        ...
        if($request->igaming){
            $igaming=$request->igaming;
        }

        if($request->tech_operations_shopify){
            $tech_operations_shopify=$request->tech_operations_shopify;
        }

        if($request->tech_operations_creative){
            $tech_operations_creative=$request->tech_operations_creative;
        }
        ...
        if($request->vcommission_uk){
            $vcommission_uk=$request->vcommission_uk;
        }
        ...
        $input = FreshEyeJournal::insert([
            ...
            'satisfaction_job_role' => $request->satisfaction_job_role,
            'well_equipped_perform_job' => $request->well_equipped_perform_job,
            'able_maintain_work_life_balance' => $request->able_maintain_work_life_balance,
            'feel_respected_my_peers' => $request->feel_respected_my_peers,
            'suggestions_heard_implemented' => $request->suggestions_heard_implemented,
            'share_good_bond_superiors' => $request->share_good_bond_superiors,
            'know_what_i_expected_to_do' => $request->know_what_i_expected_to_do,
            'i_feel_grow_in_organization' => $request->i_feel_grow_in_organization,
            ...
            'recruitment_process' => $request->recruitment_process,
            'induction_process' => $request->induction_process,
            'on_job_training_process' => $request->on_job_training_process,
            'clear_communication_changes_policy' => $request->clear_communication_changes_policy,
            'feeling_belongingness_organization' => $request->feeling_belongingness_organization,
            'having_best_friend_at_work' => $request->having_best_friend_at_work,
            ...
            'quickness_in_respond_reporting_manager' => $request->quickness_in_respond_reporting_manager,
            'how_well_received_guidance_reporting_manager' => $request->how_well_received_guidance_reporting_manager,
            'how_clearly_your_goals_set_reporting_manager' => $request->how_clearly_your_goals_set_reporting_manager,
            'how_transparent_is_reporting_manager' => $request->how_transparent_is_reporting_manager,
            'wprs_happen_every_week_reporting_manager' => $request->wprs_happen_every_week_reporting_manager,
            'how_well_adjust_changing_priorities_reporting_manager' => $request->how_well_adjust_changing_priorities_reporting_manager,
            'how_comfortable_feel_sharing_feedback_reporting_manager' => $request->how_comfortable_feel_sharing_feedback_reporting_manager,
            'how_well_able_learn_under_guidance_reporting_manager' => $request->how_well_able_learn_under_guidance_reporting_manager,
            'our_organization_believes_mantra' => $request->our_organization_believes_mantra,
            'quickness_in_respond_reporting_manager_qi' => $request->quickness_in_respond_reporting_manager_qi,
            'how_well_received_guidance_reporting_manager_qi' => $request->how_well_received_guidance_reporting_manager_qi,
            'how_clearly_your_goals_set_reporting_manager_qi' => $request->how_clearly_your_goals_set_reporting_manager_qi,
            'how_transparent_is_reporting_manager_qi' => $request->how_transparent_is_reporting_manager_qi,
            'frequent_1_1_happen_reporting_manager_qi' => $request->frequent_1_1_happen_reporting_manager_qi,
            'how_well_adjust_changing_priorities_reporting_manager_qi' => $request->how_well_adjust_changing_priorities_reporting_manager_qi,

            'how_comfortable_feel_sharing_feedback_reporting_manager_qi' => $request->how_comfortable_feel_sharing_feedback_reporting_manager_qi,
            ...
            'quickness_in_respond_hod_qj' => $request->quickness_in_respond_hod_qj,
            'how_well_received_guidance_hod_qj' => $request->how_well_received_guidance_hod_qj,
            'how_clearly_your_goals_set_hod_qj' => $request->how_clearly_your_goals_set_hod_qj,
            'how_transparent_is_hod_qj' => $request->how_transparent_is_hod_qj,
            'frequent_1_1_happen_hod_qj' => $request->frequent_1_1_happen_hod_qj,
            'how_well_adjust_changing_priorities_hod_qj' => $request->how_well_adjust_changing_priorities_hod_qj,
            'how_comfortable_feel_sharing_feedback_hod_qj' => $request->how_comfortable_feel_sharing_feedback_hod_qj,
            ...
            'tech_operations_development' => $tech_operations_development,
            'support_ea_pa' => $support_ea_pa,
            'education' => $education,
            'igaming' => $igaming,
            'tech_operations_shopify' => $tech_operations_shopify,
            'tech_operations_creative' => $tech_operations_creative,
            'mobile' => $mobile,
            'vcommission_uk' => $vcommission_uk,
    ...
    public function edit($id)
    {
        ...
        if($fresh_eye_journal_details['status']==1){
            ...
            return view('fresh-eye-journal-form-edit', compact('designation_details','department_details','company_names','company_locations','manager_details','hod_details','fresh_eye_journal_details'));
