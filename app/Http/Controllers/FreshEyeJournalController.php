...
class FreshEyeJournalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = FreshEyeJournal::insert([
            ...
            'satisfaction_job_role' => (!is_null($request->satisfaction_job_role) ? $request->satisfaction_job_role : "NA"),
            'well_equipped_perform_job' => (!is_null($request->well_equipped_perform_job) ? $request->well_equipped_perform_job : "NA"),
            'able_maintain_work_life_balance' => (!is_null($request->able_maintain_work_life_balance) ? $request->able_maintain_work_life_balance : "NA"),
            'feel_respected_my_peers' => (!is_null($request->feel_respected_my_peers) ? $request->feel_respected_my_peers : "NA"),
            'suggestions_heard_implemented' => (!is_null($request->suggestions_heard_implemented) ? $request->suggestions_heard_implemented : "NA"),
            'share_good_bond_superiors' => (!is_null($request->share_good_bond_superiors) ? $request->share_good_bond_superiors : "NA"),
            'know_what_i_expected_to_do' => (!is_null($request->know_what_i_expected_to_do) ? $request->know_what_i_expected_to_do : "NA"),
            'i_feel_grow_in_organization' => (!is_null($request->i_feel_grow_in_organization) ? $request->i_feel_grow_in_organization : "NA"),
            ...
            'work_culture' => (!is_null($request->work_culture) ? $request->work_culture : "NA"),
            'recruitment_process' => (!is_null($request->recruitment_process) ? $request->recruitment_process : "NA"),
            'induction_process' => (!is_null($request->induction_process) ? $request->induction_process : "NA"),
            'on_job_training_process' => (!is_null($request->on_job_training_process) ? $request->on_job_training_process : "NA"),
            'clear_communication_changes_policy' => (!is_null($request->clear_communication_changes_policy) ? $request->clear_communication_changes_policy : "NA"),
            'feeling_belongingness_organization' => (!is_null($request->feeling_belongingness_organization) ? $request->feeling_belongingness_organization : "NA"),
            'having_best_friend_at_work' => (!is_null($request->having_best_friend_at_work) ? $request->having_best_friend_at_work : "NA"),
            'work_life_balance' => (!is_null($request->work_life_balance) ? $request->work_life_balance : "NA"),
            'any_detailed_feedback_support_your_response' => $request->any_detailed_feedback_support_your_response,
            'quickness_in_respond_reporting_manager' => (!is_null($request->quickness_in_respond_reporting_manager) ? $request->quickness_in_respond_reporting_manager : "NA"),
            'how_well_received_guidance_reporting_manager' => (!is_null($request->how_well_received_guidance_reporting_manager) ? $request->how_well_received_guidance_reporting_manager : "NA"),
            'how_clearly_your_goals_set_reporting_manager' => (!is_null($request->how_clearly_your_goals_set_reporting_manager) ? $request->how_clearly_your_goals_set_reporting_manager : "NA"),
            'how_transparent_is_reporting_manager' => (!is_null($request->how_transparent_is_reporting_manager) ? $request->how_transparent_is_reporting_manager : "NA"),
            'wprs_happen_every_week_reporting_manager' => (!is_null($request->wprs_happen_every_week_reporting_manager) ? $request->wprs_happen_every_week_reporting_manager : "NA"),
            'how_well_adjust_changing_priorities_reporting_manager' => (!is_null($request->how_well_adjust_changing_priorities_reporting_manager) ? $request->how_well_adjust_changing_priorities_reporting_manager : "NA"),
            'how_comfortable_feel_sharing_feedback_reporting_manager' => (!is_null($request->how_comfortable_feel_sharing_feedback_reporting_manager) ? $request->how_comfortable_feel_sharing_feedback_reporting_manager : "NA"),
            'how_well_able_learn_under_guidance_reporting_manager' => (!is_null($request->how_well_able_learn_under_guidance_reporting_manager) ? $request->how_well_able_learn_under_guidance_reporting_manager : "NA"),
