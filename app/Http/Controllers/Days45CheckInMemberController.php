...
class Days45CheckInMemberController extends Controller
{
    ...
    public function index()
    {
        ...
        if(($check_in_member_details === null) or (($check_in_member_details->status === '0') or ($check_in_member_details->status === ''))){
            ...
            return view('member-check-in-form', compact('company_names','company_locations','manager_details','hod_details','hr_details','yourself_category_details'));
            ...
            return view('member-check-in-form-show', compact('company_names','company_locations','manager_details','hod_details','hr_details','yourself_category_details','check_in_member_details'));
        }
    ...
    public function store(Request $request)
    {
        ...
        $input = DB::table('days_45_checkin_members')->insert([
            ...
            'company_work_culture' => $request->company_work_culture,
            'processes_policies_well_defined' => $request->processes_policies_well_defined,
            'enjoy_work_life_balance' => $request->enjoy_work_life_balance,
            'happy_with_treated_in_company' => $request->happy_with_treated_in_company,
            'job_title_kras' => $request->job_title_kras,
            'necessary_resources_available' => $request->necessary_resources_available,
            'feel_grow_in_organization' => $request->feel_grow_in_organization,
            'complete_clarity_my_role' => $request->complete_clarity_my_role,
            'overall_happy_with_job_role' => $request->overall_happy_with_job_role,
            'training_elaborative_well_explained' => $request->training_elaborative_well_explained,
            'training_duration_apt' => $request->training_duration_apt,
            'proper_modules_defined_topic' => $request->proper_modules_defined_topic,
            'adequate_supporting_material' => $request->adequate_supporting_material,
            'clarity_on_topics_during_training' => $request->clarity_on_topics_during_training,
            'great_relationship_with_manager' => $request->great_relationship_with_manager,
            'reviewed_properly_feedback_shared_timely' => $request->reviewed_properly_feedback_shared_timely,
            'openly_share_opinions' => $request->openly_share_opinions,
            'receive_adequate_guidance' => $request->receive_adequate_guidance,
            'receive_adequate_timely_feedback' => $request->receive_adequate_timely_feedback,
            'get_quick_resolution_issue' => $request->get_quick_resolution_issue,
            ...
            'receive_proper_job_kra' => $request->receive_proper_job_kra,
            'proper_training_plan' => $request->proper_training_plan,
            'training_executed_planned' => $request->training_executed_planned,
            'marked_regularly_your_eod' => $request->marked_regularly_your_eod,
            'wpr_happen_atleast_once_week' => $request->wpr_happen_atleast_once_week,
            'one_to_one_interaction' => $request->one_to_one_interaction,
    ...
    public function edit($id)
    {
        ...
        if($check_in_member_details->status === '1'){
            ...
            return view('member-check-in-form-edit', compact('company_names','company_locations','manager_details','hod_details','hr_details','yourself_category_details','check_in_member_details'));
