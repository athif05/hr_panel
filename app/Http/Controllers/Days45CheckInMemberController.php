...
class Days45CheckInMemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = DB::table('days_45_checkin_members')->insert([
            ...
            'target' => (!is_null($request->target) ? $request->target : "NA"),
            'response' => (!is_null($request->response) ? $request->response : "NA"),
            'jd' => (!is_null($request->jd) ? $request->jd : "NA"),
            'reliability' => (!is_null($request->reliability) ? $request->reliability : "NA"),
            'team_spirit' => (!is_null($request->team_spirit) ? $request->team_spirit : "NA"),
            'attendance' => (!is_null($request->attendance) ? $request->attendance : "NA"),
            'attitude' => (!is_null($request->attitude) ? $request->attitude : "NA"),
            'rules' => (!is_null($request->rules) ? $request->rules : "NA"),
            'peers' => (!is_null($request->peers) ? $request->peers : "NA"),
            ...
            'company_work_culture' => (!is_null($request->company_work_culture) ? $request->company_work_culture : "NA"),
            'processes_policies_well_defined' => (!is_null($request->processes_policies_well_defined) ? $request->processes_policies_well_defined : "NA"),
            'enjoy_work_life_balance' => (!is_null($request->enjoy_work_life_balance) ? $request->enjoy_work_life_balance : "NA"),
            'happy_with_treated_in_company' => (!is_null($request->happy_with_treated_in_company) ? $request->happy_with_treated_in_company : "NA"),
            'job_title_kras' => (!is_null($request->job_title_kras) ? $request->job_title_kras : "NA"),
            'necessary_resources_available' => (!is_null($request->necessary_resources_available) ? $request->necessary_resources_available : "NA"),
            'feel_grow_in_organization' => (!is_null($request->feel_grow_in_organization) ? $request->feel_grow_in_organization : "NA"),
            'complete_clarity_my_role' => (!is_null($request->complete_clarity_my_role) ? $request->complete_clarity_my_role : "NA"),
            'overall_happy_with_job_role' => (!is_null($request->overall_happy_with_job_role) ? $request->overall_happy_with_job_role : "NA"),
            'training_elaborative_well_explained' => (!is_null($request->training_elaborative_well_explained) ? $request->training_elaborative_well_explained : "NA"),
            'training_duration_apt' => (!is_null($request->training_duration_apt) ? $request->training_duration_apt : "NA"),
            'proper_modules_defined_topic' => (!is_null($request->proper_modules_defined_topic) ? $request->proper_modules_defined_topic : "NA"),
            'adequate_supporting_material' => (!is_null($request->adequate_supporting_material) ? $request->adequate_supporting_material : "NA"),
            'clarity_on_topics_during_training' => (!is_null($request->clarity_on_topics_during_training) ? $request->clarity_on_topics_during_training : "NA"),
            'great_relationship_with_manager' => (!is_null($request->great_relationship_with_manager) ? $request->great_relationship_with_manager : "NA"),
            'reviewed_properly_feedback_shared_timely' => (!is_null($request->reviewed_properly_feedback_shared_timely) ? $request->reviewed_properly_feedback_shared_timely : "NA"),
            'openly_share_opinions' => (!is_null($request->openly_share_opinions) ? $request->openly_share_opinions : "NA"),
            'receive_adequate_guidance' => (!is_null($request->receive_adequate_guidance) ? $request->receive_adequate_guidance : "NA"),
            'receive_adequate_timely_feedback' => (!is_null($request->receive_adequate_timely_feedback) ? $request->receive_adequate_timely_feedback : "NA"),
            'get_quick_resolution_issue' => (!is_null($request->get_quick_resolution_issue) ? $request->get_quick_resolution_issue : "NA"),
            ...
            'receive_proper_job_kra' => (!is_null($request->receive_proper_job_kra) ? $request->receive_proper_job_kra : "NA"),
            'proper_training_plan' => (!is_null($request->proper_training_plan) ? $request->proper_training_plan : "NA"),
            'training_executed_planned' => (!is_null($request->training_executed_planned) ? $request->training_executed_planned : "NA"),
            'marked_regularly_your_eod' => (!is_null($request->marked_regularly_your_eod) ? $request->marked_regularly_your_eod : "NA"),
            'wpr_happen_atleast_once_week' => (!is_null($request->wpr_happen_atleast_once_week) ? $request->wpr_happen_atleast_once_week : "NA"),
            'one_to_one_interaction' => (!is_null($request->one_to_one_interaction) ? $request->one_to_one_interaction : "NA"),
