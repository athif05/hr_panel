...
class Days45CheckInMemberController extends Controller
{
    ...
    public function index()
    {
        ...
        $yoursel_category_details = PlaceYourselfCategory::where('status', '1')
            ->where('is_deleted', '0')
            ->orderBy('name','asc')
            ->get();
        ...
        return view('member-check-in-form', compact('company_names','company_locations','manager_details','hod_details','hr_details','yoursel_category_details'));
    }
