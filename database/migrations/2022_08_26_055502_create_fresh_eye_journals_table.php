...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fresh_eye_journals', function (Blueprint $table) {
            ...
            $table->enum('satisfaction_job_role', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('well_equipped_perform_job', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('able_maintain_work_life_balance', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('feel_respected_my_peers', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('suggestions_heard_implemented', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('share_good_bond_superiors', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('know_what_i_expected_to_do', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('i_feel_grow_in_organization', ['','NA','1','2','3','4','5'])->default('');
            ...
            $table->enum('work_culture', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('recruitment_process', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('induction_process', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('on_job_training_process', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('clear_communication_changes_policy', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('feeling_belongingness_organization', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('having_best_friend_at_work', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('work_life_balance', ['','NA','1','2','3','4','5'])->default('');
            $table->text('any_detailed_feedback_support_your_response')->nullable();
            $table->enum('quickness_in_respond_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_well_received_guidance_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_clearly_your_goals_set_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_transparent_is_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('wprs_happen_every_week_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_well_adjust_changing_priorities_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_comfortable_feel_sharing_feedback_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
            $table->enum('how_well_able_learn_under_guidance_reporting_manager', ['','NA','1','2','3','4','5'])->default('');
