...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fresh_eye_journals', function (Blueprint $table) {
            ...
            $table->enum('how_transparent_is_reporting_manager_qi', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('frequent_1_1_happen_reporting_manager_qi', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('how_well_adjust_changing_priorities_reporting_manager_qi', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('how_comfortable_feel_sharing_feedback_reporting_manager_qi', ['NA','1','2','3','4','5'])->default('NA');
            ...
            $table->enum('how_transparent_is_hod_qj', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('frequent_1_1_happen_hod_qj', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('how_well_adjust_changing_priorities_hod_qj', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('how_comfortable_feel_sharing_feedback_hod_qj', ['NA','1','2','3','4','5'])->default('NA');
            ...
            $table->enum('finance_accounts', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('human_resources', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('management', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('network_operations', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('pocket_money', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('publishers', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('tech_operations_development', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('support_ea_pa', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('education', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('igaming', ['NA','1','2','3','4','5'])->default('NA');
            $table->enum('tech_operations_shopify', ['NA','1','2','3','4','5'])->default('NA');
