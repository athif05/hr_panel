...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('training_surveys', function (Blueprint $table) {
            ...
            $table->text('additional_feedback_trainer_5')->nullable();
            ...
            $table->text('is_there_any_topic')->nullable();
            $table->text('interesting_part_elaborate')->nullable();
            $table->text('any_suggestions_feedback')->nullable();
