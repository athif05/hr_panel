...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::get('/annual-review-manager-feedback-list/{form_id}',[App\Http\Controllers\AnnualReviewManagerFeedbackController::class, 'index'])->middleware('isManagerHrandHrHead');

	Route::get('annual-review-manager-feedback-form/{form_id}/{member_id}',[App\Http\Controllers\AnnualReviewManagerFeedbackController::class, 'show'])->middleware('isManagerHrandHrHead');
	...
	Route::get('/annual-review-manager-feedback-form-edit/{form_id}/{member_id}/{edit_id}', [App\Http\Controllers\AnnualReviewManagerFeedbackController::class, 'edit'])->middleware('isManagerHrandHrHead');
	...
	Route::get('/annual-review-manager-feedback-form-show/{form_id}/{member_id}/{edit_id}', [App\Http\Controllers\AnnualReviewManagerFeedbackController::class, 'showDetails'])->middleware('isManagerHrandHrHead');
	/* annual review manager feedback, end here*/


	/* annual review mom, start here*/
	Route::get('/annual-review-mom-list/{form_id}',[App\Http\Controllers\AnnualReviewMomController::class, 'index'])->middleware('isManagerHrandHrHead');

	Route::get('/annual-review-mom-form/{form_id}/{member_id}',[App\Http\Controllers\AnnualReviewMomController::class, 'showForm'])->middleware('isManagerHrandHrHead');
	...
	Route::get('/annual-review-mom-form-edit/{form_id}/{member_id}/{edit_id}', [App\Http\Controllers\AnnualReviewMomController::class, 'edit'])->middleware('isManagerHrandHrHead');
	...
	Route::get('/annual-review-mom-form-show/{form_id}/{member_id}/{edit_id}', [App\Http\Controllers\AnnualReviewMomController::class, 'showDetails'])->middleware('isManagerHrandHrHead');
