    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Initiating PIP Email</h5>
              ...
              <form method="post" action="{{ route('update-initiating-pip-email-form') }}" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control disable-text" name="member_name" id="member_name" value="{{ $initiating_pip_details->member_name }}" readonly>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="date" class="form-control" name="date_initiating_pip" id="date_initiating_pip" value="{{ old('date_initiating_pip',$initiating_pip_details->member_name) }}">
                 ...
                 <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control" name="no_of_days" id="no_of_days" value="{{ old('no_of_days', $initiating_pip_details->no_of_days) }}">
