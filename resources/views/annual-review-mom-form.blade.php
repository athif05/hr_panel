...
@section("title")
    ...
    <title>Annual Review MOM Form | {{ env('MY_SITE_NAME') }}</title>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">{{ $survey_form_details['form_name'] }} | Annual Review MOM Form</h5>
              ...
              <form method="post" action="{{ route('save-annual-review-mom-form') }}" class="row g-3 needs-validation" novalidate>
                @csrf
                ...
                <div class="col-md-12 position-relative" id="recommend_for_promotion_id_div" @if(old('recommend_for_promotion')=="No") style="display: none;" @else style="display: block;" @endif>
