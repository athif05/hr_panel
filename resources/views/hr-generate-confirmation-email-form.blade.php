        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{ route('save-generate-email-form') }}" class="row g-3 needs-validation" novalidate>
                @csrf
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control disable-text" name="appraisal_cycle" id="appraisal_cycle" value="{{ $user_details->appraisal_cycle }}" readonly>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="letter_type" id="letter_type">
                    ...
                    <option value="{{$lettre_type['id']}}" @if(old('letter_type')==$lettre_type['id']) selected @endif>{{$lettre_type['name']}}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-md-6 position-relative" style="display: @if((old('letter_type')=='2') || (old('letter_type')=='5')) block @else none @endif;" id="increment_amount_div">
                ...
                <div class="col-md-6 position-relative" style="display: @if((old('letter_type')=='3') || (old('letter_type')=='5')) block @else none @endif;" id="promotion_div">
                  <label for="promotion" class="form-label">Promotion </label>
                  <select class="form-select" name="promotion" id="promotion">
                    <option value="">-- Choose --</option>
                    @foreach($designation_names as $designation_name)
                    <option value="{{$designation_name['id']}}" @if(old('promotion')==$designation_name['id']) selected @endif>{{$designation_name['name']}}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-md-6 position-relative" style="display: @if(old('letter_type')!='4') block @else none @endif;" id="appraisal_effect_date_div">
                ...
                <div class="col-md-6 position-relative" style="display: @if(old('letter_type')=='4') block @else none @endif;" id="pip_month_div">
                  ...
                  <input type="month" class="form-control" name="pip_month" id="pip_month" value="{{ old('pip_month')  }}" min="{{ date('Y-m') }}">
                  @if ($errors->has('pip_month'))
                    <span class="text-danger">{{ $errors->first('pip_month') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative" style="display: @if(old('letter_type')=='4') block @else none @endif;" id="final_confirmation_date_div">
                  ...
                  <input type="date" class="form-control" name="final_confirmation_date" id="final_confirmation_date" value="{{ old('final_confirmation_date')  }}" min="{{ date('Y-m-d') }}">
                  @if ($errors->has('final_confirmation_date'))
                    <span class="text-danger">{{ $errors->first('final_confirmation_date') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative" style="display: @if(old('letter_type')=='4') block @else none @endif;" id="revised_appraisl_cycle_div">
                  ...
                  <input type="month" class="form-control" name="revised_appraisl_cycle" id="revised_appraisl_cycle" value="{{ old('revised_appraisl_cycle')  }}" min="{{ date('Y-m') }}">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="poc_name" id="poc_name">
                    ...
                    <option value="{{$poc_detail['id']}}" @if(old('poc_name')==$poc_detail['id']) selected @endif>{{$poc_detail['full_name']}}</option>
                    @endforeach
                  </select>
