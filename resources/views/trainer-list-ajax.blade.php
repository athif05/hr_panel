...
@foreach($trainer_details as $trainer_detail)
            ...
            <div class="col-md-12 position-relative">
              ...
              <span id="radioBtn">
                ...
                <input class="form-check-input" type="radio" name="expertise_on_subject_matter_{{$j}}" id="expertise_on_subject_matter_{{$j}}" value="NA" @if(old('expertise_on_subject_matter_{{$j}}')=='NA') checked @endif>
            ...
            <div class="col-md-12 position-relative">
              ...
              <span id="radioBtn">
                ...
                <input class="form-check-input" type="radio" name="clear_effective_communication_skills_{{ $j }}" id="clear_effective_communication_skills_{{ $j }}" value="NA" @if(old('clear_effective_communication_skills_{{ $j }}')=='NA') checked @endif>
                <label class="form-check-label" for="gridRadios1">NA</label>
              </span>
            ...
            <div class="col-md-12 position-relative">
              ...
              <span id="radioBtn">
                ...
                <input class="form-check-input" type="radio" name="effective_delivery_content_{{ $j }}" id="effective_delivery_content_{{ $j }}" value="NA" @if(old('effective_delivery_content_{{ $j }}')=='NA') checked @endif>
                <label class="form-check-label" for="gridRadios1">NA</label>
              </span>
            ...
            <div class="col-md-12 position-relative">
              ...
              <span id="radioBtn">
                ...
                <input class="form-check-input" type="radio" name="timely_response_queries_{{ $j }}" id="timely_response_queries_{{ $j }}" value="NA" @if(old('timely_response_queries_{{ $j }}')=='NA') checked @endif>
                <label class="form-check-label" for="gridRadios1">NA</label>
              </span>
            ...
            <div class="col-md-12 position-relative">
              ...
              <span id="radioBtn">
                ...
                <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_{{ $j }}" id="comfortability_sharing_concerns_doubts_{{ $j }}" value="NA" @if(old('comfortability_sharing_concerns_doubts_{{ $j }}')=='NA') checked @endif>
                <label class="form-check-label" for="gridRadios1">NA</label>
              </span>
