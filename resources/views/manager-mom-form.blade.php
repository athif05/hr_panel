            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('save-manager-mom') }}" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="content" id="content" value="NA" @if(old('content')=='NA') checked @elseif(old('content')=='') checked @endif onclick="agv_rat_fun()">
                    ...
                    <input class="form-check-input" type="radio" name="content" id="content" value="2" onclick="agv_rat_fun()" @if(old('content')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="content" id="content" value="3" onclick="agv_rat_fun()" @if(old('content')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="content" id="content" value="4" onclick="agv_rat_fun()" @if(old('content')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="content" id="content" value="5" onclick="agv_rat_fun()" @if(old('content')=='5') checked @endif>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="confidence" id="confidence" value="NA" @if(old('confidence')=='NA') checked @elseif(old('confidence')=='') checked @endif onclick="agv_rat_fun()">
                    <label class="form-check-label" for="gridRadios1">NA</label>
                    ...
                    <input class="form-check-input" type="radio" name="confidence" id="confidence" value="2" onclick="agv_rat_fun()" @if(old('confidence')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="confidence" id="confidence" value="3" onclick="agv_rat_fun()" @if(old('confidence')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="confidence" id="confidence" value="4" onclick="agv_rat_fun()" @if(old('confidence')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="confidence" id="confidence" value="5" onclick="agv_rat_fun()" @if(old('confidence')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="communication" id="communication" value="NA" @if(old('communication')=='NA') checked @elseif(old('communication')=='') checked @endif onclick="agv_rat_fun()">
                    <label class="form-check-label" for="gridRadios1">NA</label>
                    ...
                    <input class="form-check-input" type="radio" name="communication" id="communication" value="2" onclick="agv_rat_fun()" @if(old('communication')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="communication" id="communication" value="3" onclick="agv_rat_fun()" @if(old('communication')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="communication" id="communication" value="4" onclick="agv_rat_fun()" @if(old('communication')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="communication" id="communication" value="5" onclick="agv_rat_fun()" @if(old('communication')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="data_relevance" id="data_relevance" value="NA" @if(old('data_relevance')=='NA') checked @elseif(old('data_relevance')=='') checked @endif onclick="agv_rat_fun()">
                    <label class="form-check-label" for="gridRadios1">NA</label>
                    ...
                    <input class="form-check-input" type="radio" name="data_relevance" id="data_relevance" value="2" onclick="agv_rat_fun()" @if(old('data_relevance')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="data_relevance" id="data_relevance" value="3" onclick="agv_rat_fun()" @if(old('data_relevance')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="data_relevance" id="data_relevance" value="4" onclick="agv_rat_fun()" @if(old('data_relevance')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="data_relevance" id="data_relevance" value="5" onclick="agv_rat_fun()" @if(old('data_relevance')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="overall_growth_individual" id="overall_growth_individual" value="NA" @if(old('overall_growth_individual')=='NA') checked @elseif(old('overall_growth_individual')=='') checked @endif onclick="agv_rat_fun()">
                    <label class="form-check-label" for="gridRadios1">NA</label>
                    ...
                    <input class="form-check-input" type="radio" name="overall_growth_individual" id="overall_growth_individual" value="2" onclick="agv_rat_fun()" @if(old('overall_growth_individual')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="overall_growth_individual" id="overall_growth_individual" value="3" onclick="agv_rat_fun()" @if(old('overall_growth_individual')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="overall_growth_individual" id="overall_growth_individual" value="4" onclick="agv_rat_fun()" @if(old('overall_growth_individual')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="overall_growth_individual" id="overall_growth_individual" value="5" onclick="agv_rat_fun()" @if(old('overall_growth_individual')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
