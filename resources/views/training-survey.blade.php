          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-6 position-relative">
                  <label for="trainer_1" class="form-label">Trainer 1 <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <select class="form-select" name="trainer_1" id="trainer_1" required>
                    <option  value="">Choose...</option>
                    @foreach($company_locations as $company_location)
                    <option value="{{$company_location['id']}}" @if(old('trainer_1')==$company_location['id']) selected @endif>{{$company_location['name']}}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    Please select a valid trainer 1.
                  </div>
                  @if ($errors->has('trainer_1'))
                    <span class="text-danger">{{ $errors->first('trainer_1') }}</span>
                  @endif
                </div>


                <div class="col-md-6 position-relative">
                  <label for="trainer_2" class="form-label">Trainer 2 <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <select class="form-select" name="trainer_2" id="trainer_2" required>
                    <option  value="">Choose...</option>
                    @foreach($company_locations as $company_location)
                    <option value="{{$company_location['id']}}" @if(old('trainer_2')==$company_location['id']) selected @endif>{{$company_location['name']}}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    Please select a valid trainer 2.
                  </div>
                  @if ($errors->has('trainer_2'))
                    <span class="text-danger">{{ $errors->first('trainer_2') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative">
                  <label for="trainer_3" class="form-label">Trainer 3 <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <select class="form-select" name="trainer_3" id="trainer_3" required>
                    <option  value="">Choose...</option>
                    @foreach($company_locations as $company_location)
                    <option value="{{$company_location['id']}}" @if(old('trainer_3')==$company_location['id']) selected @endif>{{$company_location['name']}}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    Please select a valid trainer 3.
                  </div>
                  @if ($errors->has('trainer_3'))
                    <span class="text-danger">{{ $errors->first('trainer_3') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative">
                  <label for="trainer_4" class="form-label">Trainer 4 <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <select class="form-select" name="trainer_4" id="trainer_4" required>
                    <option  value="">Choose...</option>
                    @foreach($company_locations as $company_location)
                    <option value="{{$company_location['id']}}" @if(old('trainer_4')==$company_location['id']) selected @endif>{{$company_location['name']}}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    Please select a valid trainer 4.
                  </div>
                  @if ($errors->has('trainer_4'))
                    <span class="text-danger">{{ $errors->first('trainer_4') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative">
                  <label for="trainer_5" class="form-label">Trainer 5 <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <select class="form-select" name="trainer_5" id="trainer_5" required>
                    <option  value="">Choose...</option>
                    @foreach($company_locations as $company_location)
                    <option value="{{$company_location['id']}}" @if(old('trainer_5')==$company_location['id']) selected @endif>{{$company_location['name']}}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    Please select a valid trainer 5.
                  </div>
                  @if ($errors->has('trainer_5'))
                    <span class="text-danger">{{ $errors->first('trainer_5') }}</span>
                  @endif
                </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="NA" @if(old('effective_delivery_content')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="1" @if(old('effective_delivery_content')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="2" @if(old('effective_delivery_content')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="3" @if(old('effective_delivery_content')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="4" @if(old('effective_delivery_content')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_1" id="effective_delivery_content_1" value="5" @if(old('effective_delivery_content')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="NA" @if(old('timely_response_queries')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="1" @if(old('timely_response_queries')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="2" @if(old('timely_response_queries')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="3" @if(old('timely_response_queries')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="4" @if(old('timely_response_queries')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_1" id="timely_response_queries_1" value="5" @if(old('timely_response_queries')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="NA" @if(old('comfortability_sharing_concerns_doubts')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="1" @if(old('comfortability_sharing_concerns_doubts')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="2" @if(old('comfortability_sharing_concerns_doubts')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="3" @if(old('comfortability_sharing_concerns_doubts')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="4" @if(old('comfortability_sharing_concerns_doubts')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_1" id="comfortability_sharing_concerns_doubts_1" value="5" @if(old('comfortability_sharing_concerns_doubts')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="NA" @if(old('effective_delivery_content')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="1" @if(old('effective_delivery_content')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="2" @if(old('effective_delivery_content')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="3" @if(old('effective_delivery_content')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="4" @if(old('effective_delivery_content')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_2" id="effective_delivery_content_2" value="5" @if(old('effective_delivery_content')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="NA" @if(old('timely_response_queries')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="1" @if(old('timely_response_queries')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="2" @if(old('timely_response_queries')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="3" @if(old('timely_response_queries')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="4" @if(old('timely_response_queries')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_2" id="timely_response_queries_2" value="5" @if(old('timely_response_queries')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="NA" @if(old('comfortability_sharing_concerns_doubts')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="1" @if(old('comfortability_sharing_concerns_doubts')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="2" @if(old('comfortability_sharing_concerns_doubts')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="3" @if(old('comfortability_sharing_concerns_doubts')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="4" @if(old('comfortability_sharing_concerns_doubts')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_2" id="comfortability_sharing_concerns_doubts_2" value="5" @if(old('comfortability_sharing_concerns_doubts')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="NA" @if(old('effective_delivery_content')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="1" @if(old('effective_delivery_content')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="2" @if(old('effective_delivery_content')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="3" @if(old('effective_delivery_content')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="4" @if(old('effective_delivery_content')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_3" id="effective_delivery_content_3" value="5" @if(old('effective_delivery_content')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="NA" @if(old('timely_response_queries')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="1" @if(old('timely_response_queries')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="2" @if(old('timely_response_queries')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="3" @if(old('timely_response_queries')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="4" @if(old('timely_response_queries')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_3" id="timely_response_queries_3" value="5" @if(old('timely_response_queries')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="NA" @if(old('comfortability_sharing_concerns_doubts')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="1" @if(old('comfortability_sharing_concerns_doubts')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="2" @if(old('comfortability_sharing_concerns_doubts')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="3" @if(old('comfortability_sharing_concerns_doubts')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="4" @if(old('comfortability_sharing_concerns_doubts')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_3" id="comfortability_sharing_concerns_doubts_3" value="5" @if(old('comfortability_sharing_concerns_doubts')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="NA" @if(old('effective_delivery_content')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="1" @if(old('effective_delivery_content')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="2" @if(old('effective_delivery_content')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="3" @if(old('effective_delivery_content')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="4" @if(old('effective_delivery_content')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_4" id="effective_delivery_content_4" value="5" @if(old('effective_delivery_content')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="NA" @if(old('timely_response_queries')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="1" @if(old('timely_response_queries')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="2" @if(old('timely_response_queries')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="3" @if(old('timely_response_queries')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="4" @if(old('timely_response_queries')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_4" id="timely_response_queries_4" value="5" @if(old('timely_response_queries')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="NA" @if(old('comfortability_sharing_concerns_doubts')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="1" @if(old('comfortability_sharing_concerns_doubts')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="2" @if(old('comfortability_sharing_concerns_doubts')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="3" @if(old('comfortability_sharing_concerns_doubts')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="4" @if(old('comfortability_sharing_concerns_doubts')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_4" id="comfortability_sharing_concerns_doubts_4" value="5" @if(old('comfortability_sharing_concerns_doubts')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="NA" @if(old('effective_delivery_content')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="1" @if(old('effective_delivery_content')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="2" @if(old('effective_delivery_content')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="3" @if(old('effective_delivery_content')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="4" @if(old('effective_delivery_content')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="effective_delivery_content_5" id="effective_delivery_content_5" value="5" @if(old('effective_delivery_content')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="NA" @if(old('timely_response_queries')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="1" @if(old('timely_response_queries')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="2" @if(old('timely_response_queries')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="3" @if(old('timely_response_queries')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="4" @if(old('timely_response_queries')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="timely_response_queries_5" id="timely_response_queries_5" value="5" @if(old('timely_response_queries')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="NA" @if(old('comfortability_sharing_concerns_doubts')=='NA') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">NA</label>

                  	  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="1" @if(old('comfortability_sharing_concerns_doubts')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="2" @if(old('comfortability_sharing_concerns_doubts')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="3" @if(old('comfortability_sharing_concerns_doubts')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="4" @if(old('comfortability_sharing_concerns_doubts')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="comfortability_sharing_concerns_doubts_5" id="comfortability_sharing_concerns_doubts_5" value="5" @if(old('comfortability_sharing_concerns_doubts')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
