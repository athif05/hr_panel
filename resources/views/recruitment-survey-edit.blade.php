            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('update-recruitment-survey-form')}}" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                  	<input class="form-check-input" type="radio" name="professionalism" id="professionalism" value="NA" @if(old('professionalism', $form_details->professionalism)=='NA') checked @elseif(old('professionalism')=='') checked @endif >
