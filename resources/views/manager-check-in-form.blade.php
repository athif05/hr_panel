              ...
              <form method="post" action="{{ route('save-manager-check-in-form') }}" class="row g-3 needs-validation" novalidate>
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="NA" @if(old('departmental_processes')=='NA') checked @elseif(old('departmental_processes')=='') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="1" @if(old('departmental_processes')=='1') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="2" @if(old('departmental_processes')=='2') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="3" @if(old('departmental_processes')=='3') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="4" @if(old('departmental_processes')=='4') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="departmental_processes" id="departmental_processes" value="5" @if(old('departmental_processes')=='5') checked @endif>
                        <div class="checkmark">
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="NA" @if(old('tod_eod_process')=='NA') checked @elseif(old('tod_eod_process')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="1" @if(old('tod_eod_process')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="2" @if(old('tod_eod_process')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="3" @if(old('tod_eod_process')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="4" @if(old('tod_eod_process')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="tod_eod_process" id="tod_eod_process" value="5" @if(old('tod_eod_process')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="NA" @if(old('month_summary_process')=='NA') checked @elseif(old('month_summary_process')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="1" @if(old('month_summary_process')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="2" @if(old('month_summary_process')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="3" @if(old('month_summary_process')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="4" @if(old('month_summary_process')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="month_summary_process" id="month_summary_process" value="5" @if(old('month_summary_process')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="NA" @if(old('relevant_software_tools')=='NA') checked @elseif(old('relevant_software_tools')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="1" @if(old('relevant_software_tools')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="2" @if(old('relevant_software_tools')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="3" @if(old('relevant_software_tools')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="4" @if(old('relevant_software_tools')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="relevant_software_tools" id="relevant_software_tools" value="5" @if(old('relevant_software_tools')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="NA" @if(old('organization_policies_processes')=='NA') checked @elseif(old('organization_policies_processes')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="1" @if(old('organization_policies_processes')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="2" @if(old('organization_policies_processes')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="3" @if(old('organization_policies_processes')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="4" @if(old('organization_policies_processes')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="organization_policies_processes" id="organization_policies_processes" value="5" @if(old('organization_policies_processes')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
