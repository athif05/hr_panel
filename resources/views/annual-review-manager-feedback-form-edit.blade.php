        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Update Annual Review Manager's feedback for {{ $member_details['first_name'] }} {{ $member_details['last_name'] }}</h5>
              ...
              <form method="post" action="{{ route('update-annual-review-manager-feedback-form')}}" class="row g-3 needs-validation" novalidate>
                @csrf
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="discipline" id="discipline" value="NA" @if(old('discipline', $feedback_form_details->discipline)=='NA') checked @elseif(old('discipline')=='') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="discipline" id="discipline" value="1" @if(old('discipline',$feedback_form_details->discipline)=='1') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="discipline" id="discipline" value="2" @if(old('discipline',$feedback_form_details->discipline)=='2') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="discipline" id="discipline" value="3" @if(old('discipline',$feedback_form_details->discipline)=='3') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="discipline" id="discipline" value="4" @if(old('discipline',$feedback_form_details->discipline)=='4') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="discipline" id="discipline" value="5" @if(old('discipline',$feedback_form_details->discipline)=='5') checked @endif>
                        <div class="checkmark">
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="punctuality" id="punctuality" value="NA" @if(old('punctuality', $feedback_form_details->punctuality)=='NA') checked @elseif(old('punctuality')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="punctuality" id="punctuality" value="1" @if(old('punctuality',$feedback_form_details->punctuality)=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="punctuality" id="punctuality" value="2" @if(old('punctuality',$feedback_form_details->punctuality)=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="punctuality" id="punctuality" value="3" @if(old('punctuality',$feedback_form_details->punctuality)=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="punctuality" id="punctuality" value="4" @if(old('punctuality',$feedback_form_details->punctuality)=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="punctuality" id="punctuality" value="5" @if(old('punctuality',$feedback_form_details->punctuality)=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="work_ethics" id="work_ethics" value="NA" @if(old('work_ethics', $feedback_form_details->work_ethics)=='NA') checked @elseif(old('work_ethics')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="work_ethics" id="work_ethics" value="1" @if(old('work_ethics',$feedback_form_details->work_ethics)=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="work_ethics" id="work_ethics" value="2" @if(old('work_ethics',$feedback_form_details->work_ethics)=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="work_ethics" id="work_ethics" value="3" @if(old('work_ethics',$feedback_form_details->work_ethics)=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="work_ethics" id="work_ethics" value="4" @if(old('work_ethics',$feedback_form_details->work_ethics)=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="work_ethics" id="work_ethics" value="5" @if(old('work_ethics',$feedback_form_details->work_ethics)=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="team_work" id="team_work" value="NA" @if(old('team_work', $feedback_form_details->team_work)=='NA') checked @elseif(old('team_work')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="team_work" id="team_work" value="1" @if(old('team_work',$feedback_form_details->team_work)=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="team_work" id="team_work" value="2" @if(old('team_work',$feedback_form_details->team_work)=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="team_work" id="team_work" value="3" @if(old('team_work',$feedback_form_details->team_work)=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="team_work" id="team_work" value="4" @if(old('team_work',$feedback_form_details->team_work)=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="team_work" id="team_work" value="5" @if(old('team_work',$feedback_form_details->team_work)=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="NA" @if(old('response_towards_feedback', $feedback_form_details->response_towards_feedback)=='NA') checked @elseif(old('response_towards_feedback')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="1" @if(old('response_towards_feedback',$feedback_form_details->response_towards_feedback)=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="2" @if(old('response_towards_feedback',$feedback_form_details->response_towards_feedback)=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="3" @if(old('response_towards_feedback',$feedback_form_details->response_towards_feedback)=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="4" @if(old('response_towards_feedback',$feedback_form_details->response_towards_feedback)=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="response_towards_feedback" id="response_towards_feedback" value="5" @if(old('response_towards_feedback',$feedback_form_details->response_towards_feedback)=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
