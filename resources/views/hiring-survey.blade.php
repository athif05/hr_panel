            ...
            <div class="card-body">
              ...
              <form method="post" action="" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control disable-text" name="location" id="location" value="{{ $member_details->location_name }}" readonly>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                ...
                <div class="col-md-12 position-relative">
                  <label for="satisfied_hiring_recruiting_process" class="form-label rdioBtn">Overall how satisfied are you with our hiring and recruiting process? <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label><br>

                  <span id="radioBtn">
                  	  <input class="form-check-input" type="radio" name="satisfied_hiring_recruiting_process" id="satisfied_hiring_recruiting_process" value="1" @if(old('satisfied_hiring_recruiting_process')=='1') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">1</label>

	                  <input class="form-check-input" type="radio" name="satisfied_hiring_recruiting_process" id="satisfied_hiring_recruiting_process" value="2" @if(old('satisfied_hiring_recruiting_process')=='2') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">2</label>

	                  <input class="form-check-input" type="radio" name="satisfied_hiring_recruiting_process" id="satisfied_hiring_recruiting_process" value="3" @if(old('satisfied_hiring_recruiting_process')=='3') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">3</label>

	                  <input class="form-check-input" type="radio" name="satisfied_hiring_recruiting_process" id="satisfied_hiring_recruiting_process" value="4" @if(old('satisfied_hiring_recruiting_process')=='4') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">4</label>

	                  <input class="form-check-input" type="radio" name="satisfied_hiring_recruiting_process" id="satisfied_hiring_recruiting_process" value="5" @if(old('satisfied_hiring_recruiting_process')=='5') checked @endif>
	                  <label class="form-check-label" for="gridRadios1">5</label>
                  </span>

                  @if ($errors->has('satisfied_hiring_recruiting_process'))
                    <span class="text-danger">{{ $errors->first('satisfied_hiring_recruiting_process') }}</span>
                  @endif
