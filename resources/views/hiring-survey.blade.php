              ...
              <form method="post" action="{{ route('save-hiring-survey') }}" class="row g-3 needs-validation" novalidate>
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="NA" @if(old('recruiter_helpful_recruitment_process')=='NA') checked @elseif(old('recruiter_helpful_recruitment_process')=='') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="1" @if(old('recruiter_helpful_recruitment_process')=='1') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="2" @if(old('recruiter_helpful_recruitment_process')=='2') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="3" @if(old('recruiter_helpful_recruitment_process')=='3') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="4" @if(old('recruiter_helpful_recruitment_process')=='4') checked @endif>
                        <div class="checkmark">
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="recruiter_helpful_recruitment_process" id="recruiter_helpful_recruitment_process" value="5" @if(old('recruiter_helpful_recruitment_process')=='5') checked @endif>
                        <div class="checkmark">
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="NA" @if(old('recruiter_response')=='NA') checked @elseif(old('recruiter_response')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="1" @if(old('recruiter_response')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="2" @if(old('recruiter_response')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="3" @if(old('recruiter_response')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="4" @if(old('recruiter_response')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="recruiter_response" id="recruiter_response" value="5" @if(old('recruiter_response')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="NA" @if(old('recruiter_understanding_job_requirement')=='NA') checked @elseif(old('recruiter_understanding_job_requirement')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="1" @if(old('recruiter_understanding_job_requirement')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="2" @if(old('recruiter_understanding_job_requirement')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="3" @if(old('recruiter_understanding_job_requirement')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="4" @if(old('recruiter_understanding_job_requirement')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="recruiter_understanding_job_requirement" id="recruiter_understanding_job_requirement" value="5" @if(old('recruiter_understanding_job_requirement')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="NA" @if(old('quality_of_candidates_presented')=='NA') checked @elseif(old('quality_of_candidates_presented')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="1" @if(old('quality_of_candidates_presented')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="2" @if(old('quality_of_candidates_presented')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="3" @if(old('quality_of_candidates_presented')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="4" @if(old('quality_of_candidates_presented')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="quality_of_candidates_presented" id="quality_of_candidates_presented" value="5" @if(old('quality_of_candidates_presented')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="NA" @if(old('number_of_candidates_presented')=='NA') checked @elseif(old('number_of_candidates_presented')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="1" @if(old('number_of_candidates_presented')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="2" @if(old('number_of_candidates_presented')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="3" @if(old('number_of_candidates_presented')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="4" @if(old('number_of_candidates_presented')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="number_of_candidates_presented" id="number_of_candidates_presented" value="5" @if(old('number_of_candidates_presented')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="NA" @if(old('rate_the_recruiter_correct_information')=='NA') checked @elseif(old('rate_the_recruiter_correct_information')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="1" @if(old('rate_the_recruiter_correct_information')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="2" @if(old('rate_the_recruiter_correct_information')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="3" @if(old('rate_the_recruiter_correct_information')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="4" @if(old('rate_the_recruiter_correct_information')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="rate_the_recruiter_correct_information" id="rate_the_recruiter_correct_information" value="5" @if(old('rate_the_recruiter_correct_information')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="NA" @if(old('assessment_screening_candidates')=='NA') checked @elseif(old('assessment_screening_candidates')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="1" @if(old('assessment_screening_candidates')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="2" @if(old('assessment_screening_candidates')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="3" @if(old('assessment_screening_candidates')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="4" @if(old('assessment_screening_candidates')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="assessment_screening_candidates" id="assessment_screening_candidates" value="5" @if(old('assessment_screening_candidates')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="NA" @if(old('time_taken_fill_open_position')=='NA') checked @elseif(old('time_taken_fill_open_position')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="1" @if(old('time_taken_fill_open_position')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="2" @if(old('time_taken_fill_open_position')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="3" @if(old('time_taken_fill_open_position')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="4" @if(old('time_taken_fill_open_position')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="time_taken_fill_open_position" id="time_taken_fill_open_position" value="5" @if(old('time_taken_fill_open_position')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    ...
                    <div class="rating">
                      <label class="form_row form_row_0">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="NA" @if(old('overall_satisfied_hiring_recruiting_process')=='NA') checked @elseif(old('overall_satisfied_hiring_recruiting_process')=='') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating0.png') }}" alt="img">
                          <p>NA</p>
                        </div>
                      ...
                      <label class="form_row form_row_1">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="1" @if(old('overall_satisfied_hiring_recruiting_process')=='1') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating5.png') }}" alt="img">
                          <p>1 <span>Poor</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_2">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="2" @if(old('overall_satisfied_hiring_recruiting_process')=='2') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating4.png') }}" alt="img">
                          <p>2 <span>Fair</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_3">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="3" @if(old('overall_satisfied_hiring_recruiting_process')=='3') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating3.png') }}" alt="img">
                          <p>3 <span>Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_4">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="4" @if(old('overall_satisfied_hiring_recruiting_process')=='4') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating2.png') }}" alt="img">
                          <p>4 <span>Very Good</span></p>
                        </div>
                      ...
                      <label class="form_row form_row_5">
                        <input type="radio" name="overall_satisfied_hiring_recruiting_process" id="overall_satisfied_hiring_recruiting_process" value="5" @if(old('overall_satisfied_hiring_recruiting_process')=='5') checked @endif>
                        <div class="checkmark">
                          <img src="{{ asset('assests/assets/img/rating1.png') }}" alt="img">
                          <p>5 <span>Outstanding</span></p>
                        </div>
