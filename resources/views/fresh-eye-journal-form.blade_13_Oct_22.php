          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{ route('save-fresh-eye-journal-form') }}" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-12 position-relative">
                  <label for="mentor_overall_feedback" class="form-label">Share your overall feedback for <span class="mentor_name_ajax_class">{{ old('mentor_name_ajax') }}</span> <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label> <br>
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="NA" @if(old('overall_feedback_for_mentor')=='NA') checked @elseif(old('overall_feedback_for_mentor')=='') checked @endif>
                    <label class="form-check-label" for="gridRadios1">NA</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="1" @if(old('overall_feedback_for_mentor')=='1') checked @endif>
                    <label class="form-check-label" for="gridRadios1">1</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="2" @if(old('overall_feedback_for_mentor')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="3" @if(old('overall_feedback_for_mentor')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="4" @if(old('overall_feedback_for_mentor')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_mentor" id="overall_feedback_for_mentor" value="5" @if(old('overall_feedback_for_mentor')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="NA" @if(old('frequent_1_1_happen_reporting_manager')=='NA') checked @elseif(old('frequent_1_1_happen_reporting_manager')=='') checked @endif>
                    <label class="form-check-label" for="gridRadios1">NA</label>

                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="1" @if(old('frequent_1_1_happen_reporting_manager')=='1') checked @endif>
                    <label class="form-check-label" for="gridRadios1">1</label>

                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="2" @if(old('frequent_1_1_happen_reporting_manager')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="3" @if(old('frequent_1_1_happen_reporting_manager')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="4" @if(old('frequent_1_1_happen_reporting_manager')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="frequent_1_1_happen_reporting_manager" id="frequent_1_1_happen_reporting_manager" value="5" @if(old('frequent_1_1_happen_reporting_manager')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <span id="radioBtn">
                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="NA" @if(old('overall_feedback_for_hod')=='NA') checked @elseif(old('overall_feedback_for_hod')=='') checked @endif>
                    <label class="form-check-label" for="gridRadios1">NA</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="1" @if(old('overall_feedback_for_hod')=='1') checked @endif>
                    <label class="form-check-label" for="gridRadios1">1</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="2" @if(old('overall_feedback_for_hod')=='2') checked @endif>
                    <label class="form-check-label" for="gridRadios1">2</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="3" @if(old('overall_feedback_for_hod')=='3') checked @endif>
                    <label class="form-check-label" for="gridRadios1">3</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="4" @if(old('overall_feedback_for_hod')=='4') checked @endif>
                    <label class="form-check-label" for="gridRadios1">4</label>

                    <input class="form-check-input" type="radio" name="overall_feedback_for_hod" id="overall_feedback_for_hod" value="5" @if(old('overall_feedback_for_hod')=='5') checked @endif>
                    <label class="form-check-label" for="gridRadios1">5</label>
                  </span>
