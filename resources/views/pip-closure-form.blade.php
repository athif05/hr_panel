    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Fill PIP Closure Form</h5>
              



              <!-- Custom Styled Validation with Tooltips -->
              <form method="post" action="{{ route('update-closure-pip-email-form') }}" class="row g-3 needs-validation" novalidate>
                @csrf
               ...
               <input type="hidden" name="no_of_days" id="no_of_days" value="{{$initiating_pip_details->no_of_days}}">
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="no_of_days_dis" id="no_of_days_dis" disabled>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="date" class="form-control disable-text" name="date_initiating_pip" id="date_initiating_pip" value="{{ old('date_initiating_pip', $initiating_pip_details->date_initiating_pip) }}" readonly>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="date" class="form-control disable-text" name="closing_date_pip" id="closing_date_pip" value="{{ old('closing_date_pip', $initiating_pip_details->closing_date_pip) }}" readonly>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control disable-text" name="issue_description_performance_behaviour" id="issue_description_performance_behaviour" style="height: 100px" readonly>{{ old('issue_description_performance_behaviour', $initiating_pip_details->issue_description_performance_behaviour)}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control disable-text" name="description_expected_performance" id="description_expected_performance" style="height: 100px" readonly>{{ old('description_expected_performance', $initiating_pip_details->description_expected_performance)}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control disable-text" name="plan_of_action_to_improve" id="plan_of_action_to_improve" style="height: 100px" readonly>{{ old('plan_of_action_to_improve', $initiating_pip_details->plan_of_action_to_improve)}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  <label for="final_pip_review" class="form-label">Final PIP Review <span class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Required"><strong>*</strong></span></label>
                  <textarea class="form-control" name="final_pip_review" id="final_pip_review" style="height: 100px">{{ old('final_pip_review', $initiating_pip_details->final_pip_review)}}</textarea>

                  @if ($errors->has('final_pip_review'))
                    <span class="text-danger">{{ $errors->first('final_pip_review') }}</span>
                  @endif

                  <script>
                    CKEDITOR.replace( 'final_pip_review' );
                  </script>
                </div>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <select class="form-select" name="confirm_the_member_after_pip" id="confirm_the_member_after_pip">
                    ...
                    <option value="Yes" @if(old('confirm_the_member_after_pip')=='Yes') selected @endif>Yes</option>
                    <option value="No" @if(old('confirm_the_member_after_pip')=='No') selected @endif>No</option>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <select class="form-select" name="final_pip_status" id="final_pip_status">
                    ...
                    <option value="{{ $pip_list['id'] }}" @if(old('final_pip_status')==$pip_list['id']) selected @endif>{{ $pip_list['name'] }}</option>
                    @endforeach
