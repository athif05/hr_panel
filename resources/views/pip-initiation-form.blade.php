          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{ route('save-initiating-pip-email-form') }}" class="row g-3 needs-validation" novalidate>
                ...
                <input type="hidden" name="updated_by_id" id="updated_by_id" value="{{ $updated_by_id }}">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="no_of_days" id="no_of_days">
                    ...
                    <option value="15 days" @if(old('no_of_days')=='15 days') selected @endif>15 days</option>
                    <option value="30 days" @if(old('no_of_days')=='30 days') selected @endif>30 days</option>
                    
                    @if($user_details['employee_type']=='Probation')
                    <option value="45 days" @if(old('no_of_days')=='45 days') selected @endif>45 days</option>
                    <option value="60 days" @if(old('no_of_days')=='60 days') selected @endif>60 days</option>
                    <option value="75 days" @if(old('no_of_days')=='75 days') selected @endif>75 days</option>
                    <option value="90 days" @if(old('no_of_days')=='90 days') selected @endif>90 days</option>
                    @endif
                  </select>
                  <div class="valid-feedback">
                    Looks good!
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="issue_description_performance_behaviour" id="issue_description_performance_behaviour" style="height: 100px">{{ old('issue_description_performance_behaviour')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="description_expected_performance" id="description_expected_performance" style="height: 100px">{{ old('description_expected_performance')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="plan_of_action_to_improve" id="plan_of_action_to_improve" style="height: 100px">{{ old('plan_of_action_to_improve')}}</textarea>
