                ...
                @foreach($all_roles as $all_role)
					<tr>
						...
						<td>
							...
							<label class="switch">
							  <input type="checkbox" id="role_{{ $all_role['id']}}" @if($all_role['status']=='1') checked @endif onclick="role_status_fun({{ $all_role['id']}})">
						...
						<td>
							...
							<label class="switch">
							  <input type="checkbox" id="role_del_{{ $all_role['id']}}" @if($all_role['is_deleted']=='1') checked @endif onclick="role_delete_fun({{ $all_role['id']}})">
							  <span class="slider round"></span>
							</label>
