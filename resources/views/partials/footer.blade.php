  ...
  <script type="text/javascript">
		...
		$(".road_fy_add").click(function(){
	        ...
	        if(total_element < max ){
	            ...
	            $("#roadFyDiv_" + nextindex).append("<div style='float: left; width: 100%; margin-top:5px;'><div style='float: left; width: 28%;'><input type='text' placeholder='Question' name='question_title[]' id='txt_1' value='' class='form-control' style='width: 98%;'></div><div style='float: left; width: 26%;'><input type='text' placeholder='Question Hint' name='question_hint[]' id='txt_1' value='' class='form-control' style='width: 98%;'></div><div style='float: left; width: 17%;'><select class='form-select' name='question_type[]' id='txt_2' style='width: 98%;'><option value='textbox'>Text Box</option><option value='textarea'>Text Area</option><option value='radiobutton'>Radio Button</option><option value='rating'>Rating</option><option value='checkbox'>Check Box</option><option value='dropdown'>Drop Down</option></select></div><div style='float: left; width: 25%;'><input type='text' name='question_value[]' id='txt_3' value='' class='form-control' style='width: 98%;'></div><div style='float: left; width: 4%; font-size: 18px; color:red; cursor: pointer; text-align: center;line-height: 46px;'><span id='roadFyRemove_" + nextindex + "' class='roadFyRemove'>X</span></div></div>");
