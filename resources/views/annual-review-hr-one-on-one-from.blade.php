    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Fill Annual Review HR 1:1 Form</h5>
              

              <div style="clear: both; height: 10px;"></div>
              <!-- Custom Styled Validation with Tooltips -->
              <form method="post" action="{{ route('save-annual-review-hr-one-on-one-form') }}" class="row g-3 needs-validation" novalidate>
                @csrf
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <select class="form-select" name="put_ever_pip" id="put_ever_pip">
                  	<option value="Yes" @if((old('put_ever_pip')=='Yes')) selected @endif>Yes</option>
                    <option value="No" @if((old('put_ever_pip')=='No') || (old('put_ever_pip')=='')) selected @endif>No</option>
                  </select>
                ...
                <div class="col-md-6 position-relative" id="pipStartDate_Div" @if(old('put_ever_pip')!='Yes')style="display: none;"@endif>
                  ...
                  <input type="date" name="pip_start_date" id="pip_start_date" value="{{ old('pip_start_date') }}" placeholder="Start Date" class="form-control">
                  @if ($errors->has('pip_start_date'))
                    <span class="text-danger">{{ $errors->first('pip_start_date') }}</span>
                  @endif
                </div>

                <div class="col-md-6 position-relative" id="pipEndDate_Div" @if(old('put_ever_pip')!='Yes')style="display: none;"@endif>
                  ...
                  <input type="date" name="pip_end_date" id="pip_end_date" value="{{ old('pip_end_date') }}" placeholder="End Date" class="form-control">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="hr_id_taking_this_1_1" id="hr_id_taking_this_1_1">
                    ...
                    <option value="{{ $hr_detail['id'] }}" @if(old('company_location_id')==$hr_detail['id']) selected @endif>{{ $hr_detail['first_name'].' '.$hr_detail['last_name'] }}</option>
                    @endforeach
                    <option value="Other" @if(old('company_location_id')=='Other') selected @endif>Other</option>
                  </select>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <select class="form-select" name="Which_level_place_yourself" id="Which_level_place_yourself">
                    ...
                    <option value="Category A : I am part of the Best Lot" @if(old('Which_level_place_yourself')=='Category A : I am part of the Best Lot') selected @endif>
                    	Category A : I am part of the Best Lot
                    </option>
                    <option value="Category B: One step below the Best lot" @if(old('Which_level_place_yourself')=='Category B: One step below the Best lot') selected @endif>
                    	Category B: One step below the Best lot
                    </option>
                    <option value="Category C: Little more to go" @if(old('Which_level_place_yourself')=='Category C: Little more to go') selected @endif>
                    	Category C: Little more to go
                    </option>
                    <option value="Category D: More efforts are required" @if(old('Which_level_place_yourself')=='Category D: More efforts are required') selected @endif>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <input type="number" class="form-control" name="total_expected_increment_monthly_salary" id="total_expected_increment_monthly_salary" value="{{ old('total_expected_increment_monthly_salary') }}" placeholder="Amount(Rs)">
                  ...
                  <input type="text" class="form-control disable-text" name="total_expected_increment_monthly_salary_percentage" id="total_expected_increment_monthly_salary_percentage" value="{{ old('total_expected_increment_monthly_salary_percentage') }}" placeholder="Percentage(%)" readonly style="margin-bottom: 8px;">

                  <input type="text" class="form-control" name="hr_notes" id="hr_notes" value="{{ old('hr_notes') }}" placeholder="HR Notes">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <select class="form-select" name="promotion_in_designation" id="promotion_in_designation">                    
                    <option value="Yes" @if(old('promotion_in_designation')=='Yes') selected @endif>Yes</option>
                    <option value="No" @if((old('promotion_in_designation')=='No') || (old('promotion_in_designation')=='')) selected @endif>No</option>
                  </select>
                ...
                <div class="col-md-6 position-relative" @if(old('promotion_in_designation')!='Yes')style="display: none;"@endif id="designation_id_promotion_div">
                  ...
                  <select class="form-select" name="designation_id_promotion" id="designation_id_promotion">
                    ...
                    <option value="{{ $designation_name['id'] }}" @if(old('company_location_id')==$designation_name['name']) selected @endif>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="share_your_accomplishments" id="share_your_accomplishments" style="height: 100px">{{ old('share_your_accomplishments')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="share_issues_challenges_impact_work" id="share_issues_challenges_impact_work" style="height: 100px">{{ old('share_issues_challenges_impact_work')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="openly_share_issues_need_closures" id="openly_share_issues_need_closures" style="height: 100px">{{ old('openly_share_issues_need_closures')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="see_yourself_moving_ahead_next_year" id="see_yourself_moving_ahead_next_year" style="height: 100px">{{ old('see_yourself_moving_ahead_next_year')}}</textarea>
                ...
                <div class="col-md-12 position-relative">
                  ...
                  <textarea class="form-control" name="any_additional_feedback_wish_to_share" id="any_additional_feedback_wish_to_share" style="height: 100px">{{ old('any_additional_feedback_wish_to_share')}}</textarea>
